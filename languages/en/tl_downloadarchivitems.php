...
$GLOBALS['TL_LANG']['tl_downloadarchivitems']['start']        	= array('Show from', 'Do not show the file on the website before this day.');
$GLOBALS['TL_LANG']['tl_downloadarchivitems']['stop']         	= array('Show until', 'Do not show the file on the website on and after this day.');
...
$GLOBALS['TL_LANG']['tl_downloadarchivitems']['toggle']     = array('Publish/unpublish file', 'Publish/unpublish file ID %s');
